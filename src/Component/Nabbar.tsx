...
function Nabbar(){
    ...
    <div className="max-w-[1110px]  h-full bg-[#ffffff] mx-auto flex justify-between px-4  text-sm font-regular items-center  ">
        ...
        <input type="search" placeholder="search for product"  className="w-[100%]  p-3 rounded-2xl border border-gray-300 " />
     ...
     <IoIosSearch className=" text-2xl align-text-top absolute right-2"/>
        ...
        <h1 className="">hello(username)</h1><RiArrowDropDownLine />
        </div>
        <h1 className="ml-">choose a language</h1><RiArrowDropDownLine />
        
        <BsCart4 className="text-3xl ml- " /><p className="w-[29] h-[]27px">Cart </p>
    </div>
    </div>
